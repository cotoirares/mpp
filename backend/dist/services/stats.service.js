...
class StatsService {
     ...
     */
    getPlayerWinPercentagesBySurface() {
        return __awaiter(this, arguments, void 0, function* (limit = 10, minMatches = 5) {
            ...
            const result = yield match_model_1.Match.aggregate([
     ...
     */
    getMatchDurationStatsBySurface() {
        return __awaiter(this, void 0, void 0, function* () {
            return match_model_1.Match.aggregate([
                // Stage 1: Join with tournaments to get surface info
                {
                    $lookup: {
                        from: 'tournaments',
    ...
    getPlayerPerformanceStats() {
        return __awaiter(this, arguments, void 0, function* (limit = 20, minMatches = 10) {
            return match_model_1.Match.aggregate([
    ...
    getTournamentStatistics() {
        return __awaiter(this, arguments, void 0, function* (limit = 10) {
            return tournament_model_1.Tournament.aggregate([
